...
@ExperimentalUnsignedTypes
class FortCosmeticVariant : UObject {
    ...
    override fun deserialize(Ar: FAssetArchive, validPos: Int) {
        ...
        variantChannelName = getOrNull("VariantChannelName")
        variantChannelTag = getOrNull<FStructFallback>("VariantChannelTag")?.getOrNull<FName>("TagName")
