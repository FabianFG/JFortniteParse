...
open class FVector : UClass {
    ...
    constructor(packedRGBA16N: FPackedRGBA16N) : this(
        (packedRGBA16N.x.toFloat() - 32767.5f) / 32767.5f,
        (packedRGBA16N.y.toFloat() - 32767.5f) / 32767.5f,
        (packedRGBA16N.z.toFloat() - 32767.5f) / 32767.5f)
    ...
    constructor(inF: Float) : this(inF, inF, inF)

    constructor(inX: Float, inY: Float, inZ: Float) {
        x = inX; y = inY; z = inZ
    }

    constructor(v: FVector2D, inZ: Float) : this(v.x, v.y, inZ)

    // constructor(v: FVector4)

    constructor(inColor: FLinearColor) : this(inColor.r, inColor.g, inColor.b)
